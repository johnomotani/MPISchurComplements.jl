...
#done
#for NT in {1..5}; do
#  OPENBLAS_NUM_THREADS=$NT mpirun -np 6 ./fortran-benchmark matrices-and-rhs.h5
#done
#for NT in {1..4}; do
#  OPENBLAS_NUM_THREADS=$NT mpirun -np 7 ./fortran-benchmark matrices-and-rhs.h5
#done
#for NT in {1..4}; do
#  OPENBLAS_NUM_THREADS=$NT mpirun -np 8 ./fortran-benchmark matrices-and-rhs.h5
#done
#for NT in {1..3}; do
#  OPENBLAS_NUM_THREADS=$NT mpirun -np 9 ./fortran-benchmark matrices-and-rhs.h5
#done
#for NT in {1..3}; do
